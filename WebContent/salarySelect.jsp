...
int total=0;
try{
	String sql="select i.id,i.name,h.salary,s.gajok,s.jikchak,s.gunsok,s.gitasudang from sudang0721 s, info0721 i,hobong0721 h where s.id=i.id and i.position=h.dunggub";
